...
long long Autopilot::startupTime = Autopilot::getCurrentTimeMillis();
using namespace Eigen;

void Autopilot::setReference(float x, float y, float z, float heading)
{
...
void Autopilot::setVelocity(float v_x, float v_y, float v_z, float psi)
{
...
void Autopilot::setAttitude(float phi_r, float theta_r, float psi_r, float z_r)
{
...
mav::Kinematics Autopilot::controllerRun(mav::Kinematics kin)
{
    float deltaT = (Autopilot::getCurrentTimeMillis() - lastTimeStamp) / 1000.0;
...
long long Autopilot::getCurrentTimeMillis()
{
