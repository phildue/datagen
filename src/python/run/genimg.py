...
sample_path = "resource/ext/samples/train_frontal_voc/"
shot_path = "resource/ext/samples/void/"
...
set_writer = DatasetParser.get_parser(sample_path, image_format='jpg', label_format='xml', start_idx=0,color_format='bgr')
